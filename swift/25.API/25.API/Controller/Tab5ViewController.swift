...
class Tab5ViewController: UITableViewController, SegementSlideContentScrollViewDelegate {
   ...
   override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
    ...
    func getData() {
        //1.リクエストを作成する
        //maxResultsは取得件数
        let urlText = "https://www.googleapis.com/youtube/v3/search?key=&q=ウマ&part=snippet&maxResults=5&order=date"
